...
class MazeCoreDiscrete2D(MazeBase):
    ...
    def update_observation(self):
        ...
        self._cell_exposed[(self._agent_grid[0] - self.visibility_2D) : (self._agent_grid[0] + self.visibility_2D), \
                (self._agent_grid[1] - self.visibility_2D) : (self._agent_grid[1] + self.visibility_2D)] = True
